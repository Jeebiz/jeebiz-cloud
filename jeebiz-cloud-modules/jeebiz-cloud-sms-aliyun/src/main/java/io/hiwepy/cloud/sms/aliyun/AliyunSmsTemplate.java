...
public class AliyunSmsTemplate {
    ...
    public SendSmsResponse send(String phoneNumber, String templateCode, Map<String, Object> templateParams, int signIdx) throws ClientException {
        return this.send(phoneNumber, templateCode, templateParams, "", signIdx);
    }

    public SendSmsResponse send(String phoneNumber, String templateCode, Map<String, Object> templateParams, String outId, int signIdx) throws ClientException {
