 ...
 * All Rights Reserved.
 */
package io.hiwepy.cloud.authz.acl.setup.config;
...
public class JeebizAuthzAclConfiguration {

    @Bean
    public FlywayFluentConfiguration flywayAuthzAclConfiguration() {

        FlywayFluentConfiguration configuration = new FlywayFluentConfiguration("acl",
                "数据权限-模块初始化", "1.0.0");
