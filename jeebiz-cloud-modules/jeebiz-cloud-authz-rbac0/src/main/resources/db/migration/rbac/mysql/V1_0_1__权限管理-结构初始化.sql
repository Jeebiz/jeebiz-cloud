...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='角色-权限关系表（角色-菜单-按钮）';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户详情信息表';
...
-- ----------------------------
-- Table structure for t_user_identity
-- ----------------------------
...
(
    ...
    `identity_id` int(1)     DEFAULT NULL COMMENT '1 教师 2 学生 3家长 4系统用户',
    `info_id`     bigint(20) DEFAULT NULL COMMENT '教师id/学生id',
    PRIMARY KEY (`id`) USING BTREE,
    KEY `idx_user_identity` (`user_id`, `identity_id`, `info_id`) USING BTREE COMMENT '用户详情索引'
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户身份信息';
