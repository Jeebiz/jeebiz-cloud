...
import io.hiwepy.cloud.message.core.emums.InformFromType;
...
@TableName("t_message_records")
@Builder
@Data
@NoArgsConstructor
@AllArgsConstructor
@EqualsAndHashCode(callSuper = false)
public class MessageRecordEntity extends PaginationEntity<MessageRecordEntity> {
