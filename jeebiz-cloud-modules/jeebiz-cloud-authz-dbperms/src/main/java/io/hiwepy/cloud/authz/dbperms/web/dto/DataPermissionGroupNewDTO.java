...
@ApiModel(value = "DataPermissionGroupNewDTO", description = "数据权限组新增参数DTO")
@Getter
@Setter
@ToString
public class DataPermissionGroupNewDTO {
     ...
     * 数据权限集合
     */
    @ApiModelProperty(name = "perms", dataType = "java.util.List<DataPermissionNewDTO>", value = "数据权限集合")
    @NotNull(message = "数据权限不能为空")
    private List<DataPermissionNewDTO> perms = Lists.newArrayList();
