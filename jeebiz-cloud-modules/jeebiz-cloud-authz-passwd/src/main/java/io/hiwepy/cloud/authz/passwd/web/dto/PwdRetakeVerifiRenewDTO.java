...
@ApiModel(value = "PwdRetakeVerifiRenewDTO", description = "账号核实字段更新参数")
@Getter
@Setter
@ToString
public class PwdRetakeVerifiRenewDTO {

    /**
     * 账号核实字段表ID
     */
    @ApiModelProperty(name = "id", required = true, dataType = "String", value = "账号核实字段表ID")
    protected String id;
    /**
     * 账号核实字段名称
     */
