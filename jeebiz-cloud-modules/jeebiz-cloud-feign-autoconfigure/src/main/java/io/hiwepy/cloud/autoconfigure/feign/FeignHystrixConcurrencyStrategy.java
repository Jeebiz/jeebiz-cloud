...
/**
 * https://www.cnblogs.com/li-zhi-long/p/11447088.html
 * RequestContextHolder.getRequestAttributes()该方法是从ThreadLocal变量里面取得相应信息的，当hystrix断路器的隔离策略为THREAD时，是无法取得ThreadLocal中的值。
 * 1、解决方案：
 * a、 hystrix隔离策略换为SEMAPHORE。
 * b、自定义策略，模仿Sleuth的trace传递。
 * c、具体可参考：http://www.itmuch.com/spring-cloud-sum/hystrix-threadlocal/
 */
@Slf4j
