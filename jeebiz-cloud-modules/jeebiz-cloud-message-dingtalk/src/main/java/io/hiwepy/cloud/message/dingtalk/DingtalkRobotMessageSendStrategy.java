 ...
 * All Rights Reserved.
 */
package io.hiwepy.cloud.message.dingtalk;
...
@Component
@Slf4j
public class DingtalkRobotMessageSendStrategy extends AbstractMessageSendStrategy {
    ...
    public InformSendChannel getChannel() {
        return InformSendChannel.DINGTALK_ROBOT;
    }
