-- ----------------------------
-- Table structure for t_device_activate
-- ----------------------------
DROP TABLE IF EXISTS `t_device_activate`;
CREATE TABLE `t_device_activate`
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='客户端激活数据表';

-- ----------------------------
-- Table structure for t_device_users
-- ----------------------------
DROP TABLE IF EXISTS `t_device_users`;
CREATE TABLE `t_device_users`
(
    `id`            bigint(12) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='设备用户关联表';
