package io.hiwepy.cloud.sample.setup.event;

import io.hiwepy.boot.api.JVMNetProxy;
import io.hiwepy.boot.api.event.SettingUpdateEvent;
...
//import io.hiwepy.javamail.authc.ProxyAuthenticator;
...
@Component
@Async
public class SettingUpdateEventListener implements ApplicationListener<SettingUpdateEvent> {

    @Override
    public void onApplicationEvent(SettingUpdateEvent event) {
