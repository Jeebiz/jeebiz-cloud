...
DELETE
FROM t_SERVICE_LIST x
WHERE x.S_ID = 'A531D662FD1BB2FCE050A8C0A10218C8';

insert into t_SERVICE_LIST (S_ID, S_ICON, S_NAME, S_ABB, S_INTRO, S_VENDOR, S_PATH, S_AUTHC, S_TYPE, S_CATEGORY, S_REC,
                            S_STATUS, S_ORDER)
values ('A531D662FD1BB2FCE050A8C0A10218C8', 'static/images/logo/base-dict.svg', '服务管理', '服务管理', null, 'Jeebiz',
        '/servmgt', 'JWT', '0', '1', '1', '1', '5');

DELETE
FROM t_SERVICE_PERMS x
WHERE x.S_ID = 'A531D662FD1BB2FCE050A8C0A10218C8';
INSERT INTO t_SERVICE_PERMS (S_ID, R_ID)
VALUES ('A531D662FD1BB2FCE050A8C0A10218C8', '8BA8036C5A8B05E1E050007F010072D3');

DELETE
FROM t_AUTHZ_FEATURE_LIST x
WHERE x.F_ID in ('5', '6', '7');
DELETE
FROM t_AUTHZ_FEATURE_OPTS x
WHERE x.F_ID in ('5', '6', '7');

INSERT INTO t_AUTHZ_FEATURE_LIST (F_ID, F_NAME, F_ABB, F_CODE, F_URL, F_TYPE, F_ICON, F_PARENT, F_VISIBLE, F_ORDER)
VALUES ('5', '服务管理', '服务管理', 'serv', '#', '1', '', 'A531D662FD1BB2FCE050A8C0A10218C8', '1', '5');
...
DELETE
FROM t_SERVICE_LIST x
WHERE x.S_ID = 'A531D662FD1CB2FCE050A8C0A10218C8';

insert into t_SERVICE_LIST (S_ID, S_ICON, S_NAME, S_ABB, S_INTRO, S_VENDOR, S_PATH, S_AUTHC, S_TYPE, S_CATEGORY, S_REC,
                            S_STATUS, S_ORDER)
values ('A531D662FD1CB2FCE050A8C0A10218C8', 'static/images/logo/base-dict.svg', '数据字典', '数据字典', null, 'Jeebiz',
        '/settings', 'JWT', '0', '1', '1', '1', '10');
...
INSERT INTO t_SERVICE_PERMS (S_ID, R_ID)
VALUES ('A531D662FD1CB2FCE050A8C0A10218C8', '8BA8036C5A8B05E1E050007F010072D3');

DELETE
FROM t_AUTHZ_FEATURE_LIST x
WHERE x.F_ID in ('10', '11', '12', '13', '14');
DELETE
FROM t_AUTHZ_FEATURE_OPTS x
WHERE x.F_ID in ('10', '11', '12', '13', '14');

INSERT INTO t_AUTHZ_FEATURE_LIST (F_ID, F_NAME, F_ABB, F_CODE, F_URL, F_TYPE, F_ICON, F_PARENT, F_VISIBLE, F_ORDER)
VALUES ('10', '数据字典', '数据字典', 'sets', '#', '1', 'icon-set', 'A531D662FD1CB2FCE050A8C0A10218C8', '1', '10');
...
DELETE
FROM t_SERVICE_LIST x
WHERE x.S_ID = 'A531D662FD1DB2FCE050A8C0A10218C8';

insert into t_SERVICE_LIST (S_ID, S_ICON, S_NAME, S_ABB, S_INTRO, S_VENDOR, S_PATH, S_AUTHC, S_TYPE, S_CATEGORY, S_REC,
                            S_STATUS, S_ORDER)
values ('A531D662FD1DB2FCE050A8C0A10218C8', 'static/images/logo/base-authz.svg', '权限管理', '权限管理', null, 'Jeebiz',
        '/authz', 'JWT', '0', '1', '1', '1', '20');
...
INSERT INTO t_SERVICE_PERMS (S_ID, R_ID)
VALUES ('A531D662FD1DB2FCE050A8C0A10218C8', '8BA8036C5A8B05E1E050007F010072D3');

DELETE
FROM t_AUTHZ_FEATURE_LIST x
WHERE x.F_ID in ('20', '21', '22', '23', '24');
DELETE
FROM t_AUTHZ_FEATURE_OPTS x
WHERE x.F_ID in ('20', '21', '22', '23', '24');

INSERT INTO t_AUTHZ_FEATURE_LIST (F_ID, F_NAME, F_ABB, F_CODE, F_URL, F_TYPE, F_ICON, F_PARENT, F_VISIBLE, F_ORDER)
VALUES ('20', '权限管理', '权限管理', 'authz-perms', '#', '1', 'layui-icon-user', 'A531D662FD1DB2FCE050A8C0A10218C8',
        '1', '20');
...
DELETE
FROM t_SERVICE_LIST x
WHERE x.S_ID = 'A531D662FD1EB2FCE050A8C0A10218C8';

insert into t_SERVICE_LIST (S_ID, S_ICON, S_NAME, S_ABB, S_INTRO, S_VENDOR, S_PATH, S_AUTHC, S_TYPE, S_CATEGORY, S_REC,
                            S_STATUS, S_ORDER)
values ('A531D662FD1EB2FCE050A8C0A10218C8', 'static/images/logo/base-inspect.svg', '安全审计', '安全审计', null,
        'Jeebiz', '/logs', 'JWT', '0', '1', '1', '1', '5');
...
INSERT INTO t_SERVICE_PERMS (S_ID, R_ID)
VALUES ('A531D662FD1EB2FCE050A8C0A10218C8', '8BA8036C5A8B05E1E050007F010072D3');

DELETE
FROM t_AUTHZ_FEATURE_LIST x
WHERE x.F_ID in ('30', '31', '32');
DELETE
FROM t_AUTHZ_FEATURE_OPTS x
WHERE x.F_ID in ('30', '31', '32');

INSERT INTO t_AUTHZ_FEATURE_LIST (F_ID, F_NAME, F_ABB, F_CODE, F_URL, F_TYPE, F_ICON, F_PARENT, F_VISIBLE, F_ORDER)
VALUES ('30', '安全审计', '安全审计', 'feature', '#', '1', '', 'A531D662FD1EB2FCE050A8C0A10218C8', '1', '30');
...
DELETE
FROM t_SERVICE_LIST x
WHERE x.S_ID = '8E2F72BB4430FAD3E050A8C0A102301B';

insert into t_SERVICE_LIST (S_ID, S_ICON, S_NAME, S_ABB, S_INTRO, S_VENDOR, S_PATH, S_AUTHC, S_TYPE, S_CATEGORY, S_REC,
                            S_STATUS, S_ORDER, S_INNER)
values ('8E2F72BB4430FAD3E050A8C0A102301B', 'static/images/logo/base-article.svg', '通知公告', '通知公告', '通知公告',
        'Jeebiz', '/article', 'JWT', '1', '1', '1', '1', '40', '1');
...
INSERT INTO t_SERVICE_PERMS (S_ID, R_ID)
VALUES ('8E2F72BB4430FAD3E050A8C0A102301B', '8BA8036C5A8B05E1E050007F010072D3');

DELETE
FROM t_AUTHZ_FEATURE_LIST x
WHERE x.F_ID in ('40', '41', '42', '43', '44');
DELETE
FROM t_AUTHZ_FEATURE_OPTS x
WHERE x.F_ID in ('40', '41', '42', '43', '44');

insert into t_AUTHZ_FEATURE_LIST (F_ID, F_NAME, F_ABB, F_CODE, F_URL, F_TYPE, F_ICON, F_ORDER, F_PARENT, F_VISIBLE)
values ('40', '通知公告', '通知公告', 'article', '#', '1', null, '40', '8E2F72BB4430FAD3E050A8C0A102301B', '1');
